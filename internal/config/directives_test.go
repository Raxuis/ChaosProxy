...
func TestParseFaults(t *testing.T) {
	...
	valid := map[string]string{
		...
		"redirect=307:https://auth.test":     "redirect=307:https://auth.test",
		"latency=800ms; redirect=302:/login": "latency=800ms; redirect=302:/login",
	}
	...
	invalid := map[string]string{
		...
		"redirect":                        "redirect needs a value, for example redirect=302:/login",
		"redirect=302":                    "redirect must be <code>:<location>",
		"redirect=302:":                   "redirect must be <code>:<location>",
		"redirect=abc:/login":             "redirect code must be 301, 302, 303, 307, or 308",
		"redirect=200:/login":             "redirect code must be 301, 302, 303, 307, or 308",
		"redirect=500:/login":             "redirect code must be 301, 302, 303, 307, or 308",
		"redirect=302:/login; status=503": "use only one",
		"redirect=302:/login; reset":      "use only one",
		"redirect=302:/login; hang":       "use only one",
